...
import { Session, UtopiaBridgeService } from '../utopia-bridge.service';
...
export class UtopiaApiService
{
    ...
    public selectBlocks(positions: Position[]): Observable<null>
    { // FIXME: ?
        const slices = [];
    ...
    private doGetInputsFromUser(descriptor: PluginInputFormDescriptor, useCache: boolean, runningPlugin: Plugin, cachedInputs: any = null): Observable<any>
    {
